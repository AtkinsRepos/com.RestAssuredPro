...
public class Listeners extends TestListenerAdapter
{
	...
	{
		htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+ "/ExtentReports/testreport.html");//specify location of the report
				
		htmlReporter.config().setDocumentTitle("RestAssuredProReport"); // Tile of report
